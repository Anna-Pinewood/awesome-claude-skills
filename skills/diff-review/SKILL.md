---
name: diff-review
description: "Browser-based review and annotation UI. **Only invoke when the user explicitly asks** — never run automatically after commits or as part of checkpoint. Triggers on: 'review this', 'let me review', '/diff-review', 'show me what changed', 'annotate this', 'comment on these lyrics', 'let me mark up this file'. Do NOT invoke proactively."
author: amenocturne
run: just -f {skill_path}/justfile launch
---
...
> **Note:** The web app implementation lives in `tools/review/`. This skill is a thin wrapper that delegates to it.
